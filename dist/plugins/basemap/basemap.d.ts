...
export declare class Basemap extends WebMapPlugin<{
     ...
     * @param layer 底图图层
     */
    createBasemapItem(key: string, layer: TileLayer): this;
    /**
     * 创建底图项
     * @param key 底图项Key值
     * @param layers 底图图层数组
     */
    createBasemapItem(key: string, layers: TileLayer[]): this;
    /**
     * 创建并设置底图项
     * @param key 底图项Key值
     * @param layer 底图图层
     */
    createBasemapItemAndSet(key: string, layer: TileLayer): this;
    /**
     * 创建并设置底图项
     * @param key 底图项Key值
     * @param layers 底图图层数组
     */
    createBasemapItemAndSet(key: string, layers: TileLayer[]): this;
}
